    ...
    "definitions": {
        ...
        "models.CreateTodolistV2": {
            ...
            "properties": {
                "address": {
                    "type": "string",
                    "example": "AIA Central Lt. 27, Jl. Jend. Sudirman No.Kav 48A, RT.5/RW.4, Karet Semanggi, Setia Budi, RT.5/RW.4, Karet Semanggi, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12930, Indonesia"
                },
                "address_benchmark": {
                    "type": "string",
        ...
        "models.ReqEditJobManagement": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "Deadline        string                     ` + "`" + `json:\"deadline\"` + "`" + `\nJobPriority     string                     ` + "`" + `json:\"jobPriority\"` + "`" + `",
                    "type": "integer",
                    "example": 3
                }
            }
