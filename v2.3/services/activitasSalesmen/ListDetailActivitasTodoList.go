...
func (svc *ServicActivitasSalesmen) ListDetailActivitasSalesmenTodolist(req dbmodels.DetailListActivitasTodolistReq, res *models.ResponsePagination) {
	fmt.Println(">>> ListActivitasSalesmen - ServicActivitasSalesmen <<<")

	data, total, err := svc.Database.DetailListActivitasTodoList(req)
	if err != nil {
